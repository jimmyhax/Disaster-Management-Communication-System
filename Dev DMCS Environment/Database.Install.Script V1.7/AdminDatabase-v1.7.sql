...
ALTER TABLE [dbo].[MemberDomains]  WITH CHECK ADD  CONSTRAINT [FK_MemberDomains_Domains] FOREIGN KEY([DomainID])
REFERENCES [dbo].[Domains] ([DomainID])
GO

ALTER TABLE [dbo].[MemberDomains] CHECK CONSTRAINT [FK_MemberDomains_Domains]
GO
