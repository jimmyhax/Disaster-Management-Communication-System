    ...
    <div class="container" ng-controller="homeCtrl" ng-app="app">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p>
                    <br />
                    <a class="btn btn-info" href="About.aspx">View &raquo;</a></p>
            </div>
            <!--/col-->
            <div class="col-md-4">
                ...
                <p>
                    <br />
                    <a class="btn btn-info" href="Management/Viewer.aspx">View &raquo;</a></p>
            </div>
            <!--/col-->
            <div class="col-md-4">
                ...
                <p>
                    <br />
                    <a class="btn btn-info" href="Management/Editor.aspx">View &raquo;</a></p>
            </div>
            <!--/col-->
        </div>
        <!--/row-->
