<%@ Page Language="C#" ValidateRequest="False" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ScriptGenerator.aspx.cs" Inherits="Web.App.ScriptGenerator" %>
    ...
    <table width="100%"  bgcolor="Silver" border="3" >
        <tr>
            <td align="center" style="padding: 10px; width:50%; font-weight: bold;">If generating from database-<br />Table Name:&nbsp;
                        <br />
                <asp:DropDownList runat="server" ID="The_Table_Name" AutoPostBack="True" DataSourceID="tableDataSource" DataTextField="TABLE_NAME" DataValueField="TABLE_NAME" OnSelectedIndexChanged="The_Table_Name_SelectedIndexChanged">
