<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="MemberDomains.aspx.cs" Inherits="Web.App.MemberDomainsClass" EnableEventValidation="True" ValidateRequest="True" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid" ng-controller="MemberDomainsCtrl">
        <div class="body-header">
            <a class="back-link"><span class="glyphicon glyphicon-menu-left back-arrow"></span><span> Home</span></a>
            <h1><span>MemberDomains CRUD Operations:</span></h1>
        </div>
                        ...
                        <div class="gridview-container" align="center">
                            <div class="gridview-contents">
                                <asp:GridView
                                    ...
                                    DataKeyNames="MemberDomainID"
                                    DataSourceID="MemberDomains_Insert_DS"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MemberDomainID" HeaderText="MemberDomainID" InsertVisible="False" ReadOnly="True" SortExpression="MemberDomainID" />
                                ...
                                <asp:SqlDataSource ID="MemberDomains_Insert_DS" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [MemberDomains]"></asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <div class="gridview-container" align="center">
                            <div class="gridview-contents">
                                <asp:GridView
                                    ...
                                    AutoGenerateColumns="False"
                                    DataKeyNames="MemberDomainID"
                                    DataSourceID="MemberDomains_Update_DS"
                                ...
                                <asp:SqlDataSource ID="MemberDomains_Update_DS" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [MemberDomains]"></asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="input-group text-center form-group">
                                <span class="pull-left">MemberDomainID</span>
                          <div class="required-container">
                              <asp:RequiredFieldValidator CssClass="required" ControlToValidate="MemberDomainID_Update_TextBox" ID="MemberDomainID_Update_RequiredFieldValidator" runat="server" Text="* Required Field" ErrorMessage="Required Field" ValidationGroup="Update_Group"></asp:RequiredFieldValidator>
                          </div>
                                <asp:TextBox class="pull-right form-control" ID="MemberDomainID_Update_TextBox" runat="server"></asp:TextBox>
                            </div>
                            <div class="input-group text-center form-group">
                                <span class="pull-left">MemberID</span>
                          <div class="required-container">
                        ...
                        <div class="gridview-container" align="center">
                            <div class="gridview-contents">
                                <asp:GridView
                                    ...
                                    AutoGenerateColumns="False"
                                    DataKeyNames="MemberDomainID"
                                    DataSourceID="MemberDomains_Delete_DS"
                                ...
                                <asp:SqlDataSource ID="MemberDomains_Delete_DS" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [MemberDomains]"></asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="input-group text-center form-group">
                                <span class="pull-left">MemberDomainID</span>
                                <asp:TextBox disabled class="pull-right form-control" ID="MemberDomainID_Delete_TextBox" runat="server"></asp:TextBox>
                            </div>
                            <div class="input-group text-center form-group">
                                <span class="pull-left">MemberID</span>
