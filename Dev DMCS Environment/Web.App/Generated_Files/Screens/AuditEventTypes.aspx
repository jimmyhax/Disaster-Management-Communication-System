<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="AuditEventTypes.aspx.cs" Inherits="Web.App.AuditEventTypesClass" EnableEventValidation="True" ValidateRequest="True" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid" ng-controller="AuditEventTypesCtrl">
        <div class="body-header">
            <a class="back-link"><span class="glyphicon glyphicon-menu-left back-arrow"></span><span> Home</span></a>
            <h1><span>AuditEventTypes CRUD Operations:</span></h1>
        </div>
                        ...
                        <div class="gridview-container" align="center">
                            <div class="gridview-contents">
                                <asp:GridView
                                    ...
                                    DataKeyNames="TypeID"
                                    DataSourceID="AuditEventTypes_Insert_DS"
                                ...
                                <asp:SqlDataSource ID="AuditEventTypes_Insert_DS" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [AuditEventTypes]"></asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <div class="gridview-container" align="center">
                            <div class="gridview-contents">
                                <asp:GridView
                                    ...
                                    AutoGenerateColumns="False"
                                    DataKeyNames="TypeID"
                                    DataSourceID="AuditEventTypes_Update_DS"
                                ...
                                <asp:SqlDataSource ID="AuditEventTypes_Update_DS" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [AuditEventTypes]"></asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="input-group text-center form-group">
                        ...
                        <div class="gridview-container" align="center">
                            <div class="gridview-contents">
                                <asp:GridView
                                    ...
                                    AutoGenerateColumns="False"
                                    DataKeyNames="TypeID"
                                    DataSourceID="AuditEventTypes_Delete_DS"
                                ...
                                <asp:SqlDataSource ID="AuditEventTypes_Delete_DS" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [AuditEventTypes]"></asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="input-group text-center form-group">
