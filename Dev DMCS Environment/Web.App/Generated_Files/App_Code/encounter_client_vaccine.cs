...
namespace Web.App
{
    public class encounter_client_vaccine : System.Web.UI.Page
    {
        ...
        public Boolean Update(encounter_client_vaccine id)
        {
            ...
            try
            {
                ...
                if (id.adult_consent == null)
                {
                    ...
                    id.adult_consent = uploaded_picture;
                }
                cmd.Parameters.AddWithValue("@adult_consent", id.adult_consent);
                if (id.guardian_consent == null)
                {
                    Size size = new Size(100, 100);
                    System.Drawing.Image image = System.Drawing.Image.FromFile(Server.MapPath("~/Content/images/placeholders/petPlaceHolder.png"));
                    Web.App.ShowImage.resizeImage(image, size);
                    byte[] uploaded_picture = Web.App.ShowImage.imageToByteArray(image);
                    id.guardian_consent = uploaded_picture;
                }
                cmd.Parameters.AddWithValue("@guardian_consent", id.guardian_consent);
                cmd.Parameters.AddWithValue("@vaccine_admin", id.vaccine_admin);
                cmd.Parameters.AddWithValue("@guardian_f_name", id.guardian_f_name);
