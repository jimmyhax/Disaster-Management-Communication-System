...
namespace Web.App
{
    public class employee : System.Web.UI.Page
    {
        ...
        public employee Select(int id)
        {
            ...
            try
            {
                ...
                if (rdr.HasRows)
                {
                    ...
                    if (!rdr.IsDBNull(2))
                    {
                        employee.employee_date_hired = rdr.GetDateTime(2);
                    }
                    else
                    {
                    ...
                    if (!rdr.IsDBNull(3))
                    {
                        employee.employee_department = rdr.GetString(3);
                    }
                    else
                    {
                    ...
                    if (!rdr.IsDBNull(4))
                    {
                        employee.employee_hours_worked = rdr.GetInt32(4);
                    }
                    else
                    {
                    ...
                    if (!rdr.IsDBNull(5))
                    {
                        employee.employee_leadership = rdr.GetString(5);
                    }
                    else
                    {
                    ...
                    if (!rdr.IsDBNull(6))
                    {
                        employee.employee_motivation = rdr.GetString(6);
                    }
                    else
                    {
                    ...
                    if (!rdr.IsDBNull(7))
                    {
                        employee.employee_notes = rdr.GetString(7);
                    }
                    else
                    {
                    ...
                    if (!rdr.IsDBNull(8))
                    {
                        employee.employee_overall = rdr.GetString(8);
                    }
                    else
                    {
                    ...
                    if (!rdr.IsDBNull(9))
                    {
                        employee.employee_payrate = rdr.GetDecimal(9);
                    }
                    else
                    {
                    ...
                    if (!rdr.IsDBNull(10))
                    {
                        employee.employee_performance = rdr.GetString(10);
                    }
                    else
                    {
                    ...
                    if (!rdr.IsDBNull(11))
                    {
                        employee.employee_quality = rdr.GetString(11);
                    }
                    else
                    {
                    ...
                    if (!rdr.IsDBNull(12))
                    {
                        employee.employee_timeliness = rdr.GetString(12);
                    }
                    else
                    {
                    ...
                    if (!rdr.IsDBNull(13))
                    {
                        employee.username = rdr.GetString(13);
                    }
                    else
                    {
                        employee.username = " ";
                    ...
                    if (!rdr.IsDBNull(14))
                    {
                        employee.pswd = rdr.GetString(14);
                    }
                    else
                    {
                        employee.pswd = " ";
        ...
        public employee Insert(employee id)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@member_id", id.member_id);
