...
namespace DotNetOpenAuth.ApplicationBlock {
	...
	public static class TwitterConsumer {
        ...
        public static bool IsTwitterConsumerConfigured
        {
            get
            {
                return !string.IsNullOrEmpty(TwitterConsumerKey) &&
                    !string.IsNullOrEmpty(TwitterConsumerSecret);
            }
        }
        ...
        private static InMemoryTokenManager ShortTermUserSessionTokenManager
        {
            get
            {
                ...
                {
                    tokenManager.ConsumerKey = TwitterConsumerKey;
                    tokenManager.ConsumerSecret = TwitterConsumerSecret;
                }
