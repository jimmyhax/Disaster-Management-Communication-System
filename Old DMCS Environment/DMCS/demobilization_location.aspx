<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="demobilization_location.aspx.cs" Inherits="DMCS.demobilization_location_" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_demobilization_location_GridView" Style="border-style: solid none none none;" 
                                            Font-Size="Medium" runat="server" DataSourceID="Insert_SqlDataSource2" AutoGenerateColumns="False" 
                                            DataKeyNames="demo_location_id" BackColor="#CCCCCC" BorderColor="#666666" BorderStyle="Solid" 
                            ...
                            <asp:BoundField DataField="demo_location_id" HeaderText="demo_location_id" InsertVisible="False" ReadOnly="True" SortExpression="demo_location_id" />
                            <asp:BoundField DataField="demo_id" HeaderText="demo_id" InsertVisible="False" ReadOnly="True" SortExpression="demo_id" />
                            <asp:BoundField DataField="location_id" HeaderText="location_id" InsertVisible="False" ReadOnly="True" SortExpression="location_id" />
                            <asp:BoundField DataField="location_description" HeaderText="location_description" InsertVisible="False" ReadOnly="True" SortExpression="location_description" Visible="false" />
                                            </Columns>
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [demo_location_id], [demo_id], [location_id], [location_description] FROM [demobilization_location]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_demobilization_location_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_demobilization_location_InfoHead_label" Style="padding: 10px" runat="server" Text="demobilization_location Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_demobilization_location_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                        ...
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_location_description_lbl" runat="server" Font-Size="Large" Text="location_description:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_location_description_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpedemobilization_locationInfo" runat="server" CollapseControlID="Insert_demobilization_location_InfoHead" CollapsedText="Show demobilization_location Information" Enabled="True" ExpandControlID="Insert_demobilization_location_InfoHead" ExpandedText="demobilization_location Information" TargetControlID="Insert_demobilization_location_InfoBody" TextLabelID="Insert_demobilization_location_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_demobilization_location_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [demo_location_id], [demo_id], [location_id], [location_description] FROM [demobilization_location]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_demobilization_location_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_demobilization_location_InfoHead_label" Style="padding: 10px" runat="server" Text="demobilization_location Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_demobilization_location_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_location_description_lbl" runat="server" Font-Size="Large" Text="location_description:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_location_description_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpedemobilization_locationInfo" runat="server" CollapseControlID="Update_demobilization_location_InfoHead" CollapsedText="Show demobilization_location Information" Enabled="True" ExpandControlID="Update_demobilization_location_InfoHead" ExpandedText="demobilization_location Information" TargetControlID="Update_demobilization_location_InfoBody" TextLabelID="Update_demobilization_location_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_demobilization_location_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [demo_location_id], [demo_id], [location_id], [location_description] FROM [demobilization_location]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_demobilization_location_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_demobilization_location_InfoHead_label" Style="padding: 10px" runat="server" Text="demobilization_location Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_demobilization_location_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_location_description_lbl" runat="server" Font-Size="Large" Text="location_description:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_location_description_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpedemobilization_locationInfo" runat="server" CollapseControlID="Delete_demobilization_location_InfoHead" CollapsedText="Show demobilization_location Information" Enabled="True" ExpandControlID="Delete_demobilization_location_InfoHead" ExpandedText="demobilization_location Information" TargetControlID="Delete_demobilization_location_InfoBody" TextLabelID="Delete_demobilization_location_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
