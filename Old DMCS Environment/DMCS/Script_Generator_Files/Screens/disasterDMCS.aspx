<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="disasterDMCS.aspx.cs" Inherits="DMCS.disasterDMCS_" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_disasterDMCS_GridView" Style="border-style: solid none none none;" 
                            ...
                            <asp:BoundField DataField="disaster_description" HeaderText="disaster_description" InsertVisible="False" ReadOnly="True" SortExpression="disaster_description" />
                                            </Columns>
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [disaster_id], [disaster_description] FROM [disasterDMCS]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_disasterDMCS_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_disasterDMCS_InfoHead_label" Style="padding: 10px" runat="server" Text="disasterDMCS Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_disasterDMCS_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                            ...
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_disaster_description_lbl" runat="server" Font-Size="Large" Text="disaster_description:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_disaster_description_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpedisasterDMCSInfo" runat="server" CollapseControlID="Insert_disasterDMCS_InfoHead" CollapsedText="Show disasterDMCS Information" Enabled="True" ExpandControlID="Insert_disasterDMCS_InfoHead" ExpandedText="disasterDMCS Information" TargetControlID="Insert_disasterDMCS_InfoBody" TextLabelID="Insert_disasterDMCS_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_disasterDMCS_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [disaster_id], [disaster_description] FROM [disasterDMCS]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_disasterDMCS_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_disasterDMCS_InfoHead_label" Style="padding: 10px" runat="server" Text="disasterDMCS Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_disasterDMCS_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_disaster_description_lbl" runat="server" Font-Size="Large" Text="disaster_description:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_disaster_description_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpedisasterDMCSInfo" runat="server" CollapseControlID="Update_disasterDMCS_InfoHead" CollapsedText="Show disasterDMCS Information" Enabled="True" ExpandControlID="Update_disasterDMCS_InfoHead" ExpandedText="disasterDMCS Information" TargetControlID="Update_disasterDMCS_InfoBody" TextLabelID="Update_disasterDMCS_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_disasterDMCS_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [disaster_id], [disaster_description] FROM [disasterDMCS]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_disasterDMCS_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_disasterDMCS_InfoHead_label" Style="padding: 10px" runat="server" Text="disasterDMCS Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_disasterDMCS_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_disaster_description_lbl" runat="server" Font-Size="Large" Text="disaster_description:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_disaster_description_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpedisasterDMCSInfo" runat="server" CollapseControlID="Delete_disasterDMCS_InfoHead" CollapsedText="Show disasterDMCS Information" Enabled="True" ExpandControlID="Delete_disasterDMCS_InfoHead" ExpandedText="disasterDMCS Information" TargetControlID="Delete_disasterDMCS_InfoBody" TextLabelID="Delete_disasterDMCS_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
