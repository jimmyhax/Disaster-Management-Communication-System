<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="Evacuation_Area_Screen.aspx.cs" Inherits="DMCS.SandBox.Generated.Evacuation_Area_Screen" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_Evacuation_Area_GridView" Style="border-style: solid none none none;" 
                                            Font-Size="Medium" runat="server" DataSourceID="Insert_SqlDataSource2" AutoGenerateColumns="False" 
                                            DataKeyNames="Evacuation_Area_ID" BackColor="#CCCCCC" BorderColor="#666666" BorderStyle="Solid" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Evacuation_Area_ID], [Location_ID] FROM [Evacuation_Area]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_Evacuation_Area_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_Evacuation_Area_InfoHead_label" Style="padding: 10px" runat="server" Text="Evacuation_Area Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_Evacuation_Area_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpeEvacuation_AreaInfo" runat="server" CollapseControlID="Insert_Evacuation_Area_InfoHead" CollapsedText="Show Evacuation_Area Information" Enabled="True" ExpandControlID="Insert_Evacuation_Area_InfoHead" ExpandedText="Evacuation_Area Information" TargetControlID="Insert_Evacuation_Area_InfoBody" TextLabelID="Insert_Evacuation_Area_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_Evacuation_Area_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Evacuation_Area_ID], [Location_ID] FROM [Evacuation_Area]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_Evacuation_Area_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_Evacuation_Area_InfoHead_label" Style="padding: 10px" runat="server" Text="Evacuation_Area Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_Evacuation_Area_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpeEvacuation_AreaInfo" runat="server" CollapseControlID="Update_Evacuation_Area_InfoHead" CollapsedText="Show Evacuation_Area Information" Enabled="True" ExpandControlID="Update_Evacuation_Area_InfoHead" ExpandedText="Evacuation_Area Information" TargetControlID="Update_Evacuation_Area_InfoBody" TextLabelID="Update_Evacuation_Area_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_Evacuation_Area_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Evacuation_Area_ID], [Location_ID] FROM [Evacuation_Area]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_Evacuation_Area_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_Evacuation_Area_InfoHead_label" Style="padding: 10px" runat="server" Text="Evacuation_Area Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_Evacuation_Area_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpeEvacuation_AreaInfo" runat="server" CollapseControlID="Delete_Evacuation_Area_InfoHead" CollapsedText="Show Evacuation_Area Information" Enabled="True" ExpandControlID="Delete_Evacuation_Area_InfoHead" ExpandedText="Evacuation_Area Information" TargetControlID="Delete_Evacuation_Area_InfoBody" TextLabelID="Delete_Evacuation_Area_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
