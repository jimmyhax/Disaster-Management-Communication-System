<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="services_Screen.aspx.cs" Inherits="DMCS.SandBox.Generated.services_Screen" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_services_GridView" Style="border-style: solid none none none;" 
                                            Font-Size="Medium" runat="server" DataSourceID="Insert_SqlDataSource2" AutoGenerateColumns="False" 
                                            DataKeyNames="service_id" BackColor="#CCCCCC" BorderColor="#666666" BorderStyle="Solid" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [service_id], [Company], [service_type], [Estimated_Time], [Email], [Phone_Number], [Full_Cost], [Estimated_Cost] FROM [services]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_services_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_services_InfoHead_label" Style="padding: 10px" runat="server" Text="services Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_services_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                            ...
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Company_lbl" runat="server" Font-Size="Large" Text="Company:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Company_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_service_type_lbl" runat="server" Font-Size="Large" Text="service_type:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_service_type_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Estimated_Time_lbl" runat="server" Font-Size="Large" Text="Estimated_Time:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Estimated_Time_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Phone_Number_lbl" runat="server" Font-Size="Large" Text="Phone_Number:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Phone_Number_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Full_Cost_lbl" runat="server" Font-Size="Large" Text="Full_Cost:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Full_Cost_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Estimated_Cost_lbl" runat="server" Font-Size="Large" Text="Estimated_Cost:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Estimated_Cost_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpeservicesInfo" runat="server" CollapseControlID="Insert_services_InfoHead" CollapsedText="Show services Information" Enabled="True" ExpandControlID="Insert_services_InfoHead" ExpandedText="services Information" TargetControlID="Insert_services_InfoBody" TextLabelID="Insert_services_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_services_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [service_id], [Company], [service_type], [Estimated_Time], [Email], [Phone_Number], [Full_Cost], [Estimated_Cost] FROM [services]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_services_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_services_InfoHead_label" Style="padding: 10px" runat="server" Text="services Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_services_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Company_lbl" runat="server" Font-Size="Large" Text="Company:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Company_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_service_type_lbl" runat="server" Font-Size="Large" Text="service_type:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_service_type_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Estimated_Time_lbl" runat="server" Font-Size="Large" Text="Estimated_Time:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Estimated_Time_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Phone_Number_lbl" runat="server" Font-Size="Large" Text="Phone_Number:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Phone_Number_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Full_Cost_lbl" runat="server" Font-Size="Large" Text="Full_Cost:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Full_Cost_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Estimated_Cost_lbl" runat="server" Font-Size="Large" Text="Estimated_Cost:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Estimated_Cost_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpeservicesInfo" runat="server" CollapseControlID="Update_services_InfoHead" CollapsedText="Show services Information" Enabled="True" ExpandControlID="Update_services_InfoHead" ExpandedText="services Information" TargetControlID="Update_services_InfoBody" TextLabelID="Update_services_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_services_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [service_id], [Company], [service_type], [Estimated_Time], [Email], [Phone_Number], [Full_Cost], [Estimated_Cost] FROM [services]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_services_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_services_InfoHead_label" Style="padding: 10px" runat="server" Text="services Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_services_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Company_lbl" runat="server" Font-Size="Large" Text="Company:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Company_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_service_type_lbl" runat="server" Font-Size="Large" Text="service_type:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_service_type_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Estimated_Time_lbl" runat="server" Font-Size="Large" Text="Estimated_Time:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Estimated_Time_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Phone_Number_lbl" runat="server" Font-Size="Large" Text="Phone_Number:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Phone_Number_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Full_Cost_lbl" runat="server" Font-Size="Large" Text="Full_Cost:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Full_Cost_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Estimated_Cost_lbl" runat="server" Font-Size="Large" Text="Estimated_Cost:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Estimated_Cost_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpeservicesInfo" runat="server" CollapseControlID="Delete_services_InfoHead" CollapsedText="Show services Information" Enabled="True" ExpandControlID="Delete_services_InfoHead" ExpandedText="services Information" TargetControlID="Delete_services_InfoBody" TextLabelID="Delete_services_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
