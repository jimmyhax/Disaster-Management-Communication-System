...
public class person
{
    ...
    public DataTable Select_Missing(string whereclause)
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("SP_DMCS_SELECT_PERSON_MISSING_OR_DECEASED_WC", con);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
    ...
    public DataTable Select_Deceased(string whereclause)
    {
        DataTable alrows = new DataTable();
        string ConnectionString = IDManager.connection();
        SqlConnection con = new SqlConnection(ConnectionString);
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("SP_DMCS_SELECT_DECEASED_PERSON_WC", con);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@wareclause", whereclause);
            SqlDataReader rdr = cmd.ExecuteReader();
            alrows.Load(rdr);
