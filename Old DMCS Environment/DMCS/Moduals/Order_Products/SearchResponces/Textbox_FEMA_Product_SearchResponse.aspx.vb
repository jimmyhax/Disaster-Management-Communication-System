...
Partial Class Textbox_FEMA_Product_SearchResponse
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("productNamesWC") <> "" Then
            strSearchProductNamesWC = CStr(Request.QueryString("productNamesWC").ToString)
        End If
        ...
        cmd.CommandText = "dbo.SP_DMCS_Location_Resources_In_Warehouse_Searchbox"
