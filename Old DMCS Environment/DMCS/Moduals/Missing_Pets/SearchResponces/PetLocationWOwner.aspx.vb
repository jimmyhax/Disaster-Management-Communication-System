...
Partial Class PetLocationWOwner
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        connDB.ConnectionString = "Data Source=WIN\SQLEXPRESS;Initial Catalog=disaster_management_DEV;Integrated Security=True"
        ''connDB.ConnectionString = "Data Source=RACH\SQLEXPRESS;Initial Catalog=disaster_management;Integrated Security=True"
        connDB.Open()
        cmd.Connection = connDB
        cmd.CommandType = Data.CommandType.StoredProcedure
        cmd.CommandTimeout = 20
        cmd.CommandText = "dbo.Pet_Location_WOwner"
