<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="locationDMCS.aspx.cs" Inherits="DMCS.locationDMCS_" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_locationDMCS_GridView" Style="border-style: solid none none none;" 
                                            Font-Size="Medium" runat="server" DataSourceID="Insert_SqlDataSource2" AutoGenerateColumns="False" 
                                            DataKeyNames="locationdmcs_id" BackColor="#CCCCCC" BorderColor="#666666" BorderStyle="Solid" 
                            ...
                            <asp:BoundField DataField="locationdmcs_id" HeaderText="locationdmcs_id" InsertVisible="False" ReadOnly="True" SortExpression="locationdmcs_id" />
                            <asp:BoundField DataField="city" HeaderText="city" InsertVisible="False" ReadOnly="True" SortExpression="city" />
                            <asp:BoundField DataField="county" HeaderText="county" InsertVisible="False" ReadOnly="True" SortExpression="county" />
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [locationdmcs_id], [city], [county], [e_lat], [e_long], [location_desc], [n_lat], [n_long], [state], [type], [w_lat], [w_long], [zip] FROM [locationDMCS]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_locationDMCS_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_locationDMCS_InfoHead_label" Style="padding: 10px" runat="server" Text="locationDMCS Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_locationDMCS_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpelocationDMCSInfo" runat="server" CollapseControlID="Insert_locationDMCS_InfoHead" CollapsedText="Show locationDMCS Information" Enabled="True" ExpandControlID="Insert_locationDMCS_InfoHead" ExpandedText="locationDMCS Information" TargetControlID="Insert_locationDMCS_InfoBody" TextLabelID="Insert_locationDMCS_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_locationDMCS_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [locationdmcs_id], [city], [county], [e_lat], [e_long], [location_desc], [n_lat], [n_long], [state], [type], [w_lat], [w_long], [zip] FROM [locationDMCS]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_locationDMCS_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_locationDMCS_InfoHead_label" Style="padding: 10px" runat="server" Text="locationDMCS Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_locationDMCS_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_locationdmcs_id_lbl" runat="server" Font-Size="Large" Text="locationdmcs_id:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_locationdmcs_id_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpelocationDMCSInfo" runat="server" CollapseControlID="Update_locationDMCS_InfoHead" CollapsedText="Show locationDMCS Information" Enabled="True" ExpandControlID="Update_locationDMCS_InfoHead" ExpandedText="locationDMCS Information" TargetControlID="Update_locationDMCS_InfoBody" TextLabelID="Update_locationDMCS_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_locationDMCS_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [locationdmcs_id], [city], [county], [e_lat], [e_long], [location_desc], [n_lat], [n_long], [state], [type], [w_lat], [w_long], [zip] FROM [locationDMCS]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_locationDMCS_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_locationDMCS_InfoHead_label" Style="padding: 10px" runat="server" Text="locationDMCS Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_locationDMCS_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_locationdmcs_id_lbl" runat="server" Font-Size="Large" Text="locationdmcs_id:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_locationdmcs_id_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpelocationDMCSInfo" runat="server" CollapseControlID="Delete_locationDMCS_InfoHead" CollapsedText="Show locationDMCS Information" Enabled="True" ExpandControlID="Delete_locationDMCS_InfoHead" ExpandedText="locationDMCS Information" TargetControlID="Delete_locationDMCS_InfoBody" TextLabelID="Delete_locationDMCS_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
