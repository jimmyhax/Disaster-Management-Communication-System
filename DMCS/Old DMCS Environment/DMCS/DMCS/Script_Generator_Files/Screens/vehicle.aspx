<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="vehicle.aspx.cs" Inherits="DMCS.vehicle_" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <asp:BoundField DataField="vehicle_brand" HeaderText="vehicle_brand" InsertVisible="False" ReadOnly="True" SortExpression="vehicle_brand" />
                            <asp:BoundField DataField="vehicle_model" HeaderText="vehicle_model" InsertVisible="False" ReadOnly="True" SortExpression="vehicle_model" />
                            ...
                            <asp:BoundField DataField="vehicle_description" HeaderText="vehicle_description" InsertVisible="False" ReadOnly="True" SortExpression="vehicle_description" Visible="false" />
                                            </Columns>
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [vehicle_id], [vehicle_brand], [vehicle_model], [vehicle_year], [vehicle_description] FROM [vehicle]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                                            ...
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_vehicle_brand_lbl" runat="server" Font-Size="Large" Text="vehicle_brand:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_vehicle_brand_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_vehicle_description_lbl" runat="server" Font-Size="Large" Text="vehicle_description:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_vehicle_description_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                ...
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [vehicle_id], [vehicle_brand], [vehicle_model], [vehicle_year], [vehicle_description] FROM [vehicle]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_vehicle_brand_lbl" runat="server" Font-Size="Large" Text="vehicle_brand:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_vehicle_brand_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_vehicle_description_lbl" runat="server" Font-Size="Large" Text="vehicle_description:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_vehicle_description_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                ...
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [vehicle_id], [vehicle_brand], [vehicle_model], [vehicle_year], [vehicle_description] FROM [vehicle]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_vehicle_brand_lbl" runat="server" Font-Size="Large" Text="vehicle_brand:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_vehicle_brand_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_vehicle_description_lbl" runat="server" Font-Size="Large" Text="vehicle_description:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_vehicle_description_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
