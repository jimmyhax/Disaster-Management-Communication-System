<%@ Page MaintainScrollPositionOnPostback="True" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Inherits="DMCS.Moduals.Evacuation.Obstructions.View_Obstruction" Title="Disaster Location" Codebehind="View_Obstruction.aspx.cs" %>
        ...
        <table width="100%" bgcolor="Silver" border="3">
            <tr>
                ...
                <td width="80%" style="border-style: none" align="Center">
                    <asp:Label ID="Label1" runat="server" Text="Search For An Obstruction" Font-Bold="True" Font-Size="20pt"></asp:Label>
                </td>
            </tr>
        </table>
