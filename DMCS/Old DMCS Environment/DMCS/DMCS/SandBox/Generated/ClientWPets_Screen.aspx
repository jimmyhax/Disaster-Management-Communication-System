<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="ClientWPets_Screen.aspx.cs" Inherits="DMCS.SandBox.Generated.ClientWPets_Screen" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_ClientWPets_GridView" Style="border-style: solid none none none;" 
                                            Font-Size="Medium" runat="server" DataSourceID="Insert_SqlDataSource2" AutoGenerateColumns="False" 
                                            DataKeyNames="CLIENTWPETS_ID" BackColor="#CCCCCC" BorderColor="#666666" BorderStyle="Solid" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [CLIENTWPETS_ID], [Pet_Record_ID], [Client_id], [Location_ID], [cp_Date], [ownership] FROM [ClientWPets]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_ClientWPets_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_ClientWPets_InfoHead_label" Style="padding: 10px" runat="server" Text="ClientWPets Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_ClientWPets_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                        ...
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_cp_Date_lbl" runat="server" Font-Size="Large" Text="cp_Date:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_cp_Date_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_ownership_lbl" runat="server" Font-Size="Large" Text="ownership:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_ownership_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpeClientWPetsInfo" runat="server" CollapseControlID="Insert_ClientWPets_InfoHead" CollapsedText="Show ClientWPets Information" Enabled="True" ExpandControlID="Insert_ClientWPets_InfoHead" ExpandedText="ClientWPets Information" TargetControlID="Insert_ClientWPets_InfoBody" TextLabelID="Insert_ClientWPets_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_ClientWPets_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [CLIENTWPETS_ID], [Pet_Record_ID], [Client_id], [Location_ID], [cp_Date], [ownership] FROM [ClientWPets]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_ClientWPets_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_ClientWPets_InfoHead_label" Style="padding: 10px" runat="server" Text="ClientWPets Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_ClientWPets_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_CLIENTWPETS_ID_lbl" runat="server" Font-Size="Large" Text="CLIENTWPETS_ID:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_CLIENTWPETS_ID_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_cp_Date_lbl" runat="server" Font-Size="Large" Text="cp_Date:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_cp_Date_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_ownership_lbl" runat="server" Font-Size="Large" Text="ownership:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_ownership_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpeClientWPetsInfo" runat="server" CollapseControlID="Update_ClientWPets_InfoHead" CollapsedText="Show ClientWPets Information" Enabled="True" ExpandControlID="Update_ClientWPets_InfoHead" ExpandedText="ClientWPets Information" TargetControlID="Update_ClientWPets_InfoBody" TextLabelID="Update_ClientWPets_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_ClientWPets_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [CLIENTWPETS_ID], [Pet_Record_ID], [Client_id], [Location_ID], [cp_Date], [ownership] FROM [ClientWPets]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_ClientWPets_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_ClientWPets_InfoHead_label" Style="padding: 10px" runat="server" Text="ClientWPets Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_ClientWPets_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_CLIENTWPETS_ID_lbl" runat="server" Font-Size="Large" Text="CLIENTWPETS_ID:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_CLIENTWPETS_ID_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_cp_Date_lbl" runat="server" Font-Size="Large" Text="cp_Date:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_cp_Date_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_ownership_lbl" runat="server" Font-Size="Large" Text="ownership:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_ownership_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpeClientWPetsInfo" runat="server" CollapseControlID="Delete_ClientWPets_InfoHead" CollapsedText="Show ClientWPets Information" Enabled="True" ExpandControlID="Delete_ClientWPets_InfoHead" ExpandedText="ClientWPets Information" TargetControlID="Delete_ClientWPets_InfoBody" TextLabelID="Delete_ClientWPets_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
