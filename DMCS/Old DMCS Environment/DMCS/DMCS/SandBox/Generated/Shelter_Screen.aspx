<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="Shelter_Screen.aspx.cs" Inherits="DMCS.SandBox.Generated.Shelter_Screen" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_Shelter_GridView" Style="border-style: solid none none none;" 
                                            Font-Size="Medium" runat="server" DataSourceID="Insert_SqlDataSource2" AutoGenerateColumns="False" 
                                            DataKeyNames="Shelter_ID" BackColor="#CCCCCC" BorderColor="#666666" BorderStyle="Solid" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Shelter_ID], [Address_ID], [Shelter_Type], [Max_Capacity], [AllowsPets] FROM [Shelter]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_Shelter_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_Shelter_InfoHead_label" Style="padding: 10px" runat="server" Text="Shelter Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_Shelter_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                        ...
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Shelter_Type_lbl" runat="server" Font-Size="Large" Text="Shelter_Type:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Shelter_Type_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Max_Capacity_lbl" runat="server" Font-Size="Large" Text="Max_Capacity:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Max_Capacity_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_AllowsPets_lbl" runat="server" Font-Size="Large" Text="AllowsPets:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_AllowsPets_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpeShelterInfo" runat="server" CollapseControlID="Insert_Shelter_InfoHead" CollapsedText="Show Shelter Information" Enabled="True" ExpandControlID="Insert_Shelter_InfoHead" ExpandedText="Shelter Information" TargetControlID="Insert_Shelter_InfoBody" TextLabelID="Insert_Shelter_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_Shelter_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Shelter_ID], [Address_ID], [Shelter_Type], [Max_Capacity], [AllowsPets] FROM [Shelter]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_Shelter_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_Shelter_InfoHead_label" Style="padding: 10px" runat="server" Text="Shelter Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_Shelter_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Shelter_Type_lbl" runat="server" Font-Size="Large" Text="Shelter_Type:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Shelter_Type_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Max_Capacity_lbl" runat="server" Font-Size="Large" Text="Max_Capacity:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Max_Capacity_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_AllowsPets_lbl" runat="server" Font-Size="Large" Text="AllowsPets:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_AllowsPets_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpeShelterInfo" runat="server" CollapseControlID="Update_Shelter_InfoHead" CollapsedText="Show Shelter Information" Enabled="True" ExpandControlID="Update_Shelter_InfoHead" ExpandedText="Shelter Information" TargetControlID="Update_Shelter_InfoBody" TextLabelID="Update_Shelter_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_Shelter_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Shelter_ID], [Address_ID], [Shelter_Type], [Max_Capacity], [AllowsPets] FROM [Shelter]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_Shelter_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_Shelter_InfoHead_label" Style="padding: 10px" runat="server" Text="Shelter Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_Shelter_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Shelter_Type_lbl" runat="server" Font-Size="Large" Text="Shelter_Type:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Shelter_Type_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Max_Capacity_lbl" runat="server" Font-Size="Large" Text="Max_Capacity:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Max_Capacity_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_AllowsPets_lbl" runat="server" Font-Size="Large" Text="AllowsPets:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_AllowsPets_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpeShelterInfo" runat="server" CollapseControlID="Delete_Shelter_InfoHead" CollapsedText="Show Shelter Information" Enabled="True" ExpandControlID="Delete_Shelter_InfoHead" ExpandedText="Shelter Information" TargetControlID="Delete_Shelter_InfoBody" TextLabelID="Delete_Shelter_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
