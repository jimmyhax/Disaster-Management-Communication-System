<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="tier_Screen.aspx.cs" Inherits="DMCS.SandBox.Generated.tier_Screen" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_tier_GridView" Style="border-style: solid none none none;" 
                                            Font-Size="Medium" runat="server" DataSourceID="Insert_SqlDataSource2" AutoGenerateColumns="False" 
                                            DataKeyNames="tier_id" BackColor="#CCCCCC" BorderColor="#666666" BorderStyle="Solid" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [tier_id], [include_req], [campaign_id], [Tier_Age_Begin_Month], [Tier_Age_Begin_Year], [Tier_Age_End_Month], [Tier_Age_End_Year] FROM [tier]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_tier_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_tier_InfoHead_label" Style="padding: 10px" runat="server" Text="tier Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_tier_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                            ...
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_include_req_lbl" runat="server" Font-Size="Large" Text="include_req:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_include_req_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_campaign_id_lbl" runat="server" Font-Size="Large" Text="campaign_id:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_campaign_id_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Tier_Age_Begin_Month_lbl" runat="server" Font-Size="Large" Text="Tier_Age_Begin_Month:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Tier_Age_Begin_Month_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Tier_Age_Begin_Year_lbl" runat="server" Font-Size="Large" Text="Tier_Age_Begin_Year:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Tier_Age_Begin_Year_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Tier_Age_End_Month_lbl" runat="server" Font-Size="Large" Text="Tier_Age_End_Month:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Tier_Age_End_Month_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Tier_Age_End_Year_lbl" runat="server" Font-Size="Large" Text="Tier_Age_End_Year:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Tier_Age_End_Year_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpetierInfo" runat="server" CollapseControlID="Insert_tier_InfoHead" CollapsedText="Show tier Information" Enabled="True" ExpandControlID="Insert_tier_InfoHead" ExpandedText="tier Information" TargetControlID="Insert_tier_InfoBody" TextLabelID="Insert_tier_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_tier_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [tier_id], [include_req], [campaign_id], [Tier_Age_Begin_Month], [Tier_Age_Begin_Year], [Tier_Age_End_Month], [Tier_Age_End_Year] FROM [tier]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_tier_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_tier_InfoHead_label" Style="padding: 10px" runat="server" Text="tier Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_tier_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_tier_id_lbl" runat="server" Font-Size="Large" Text="tier_id:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_tier_id_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_include_req_lbl" runat="server" Font-Size="Large" Text="include_req:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_include_req_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_campaign_id_lbl" runat="server" Font-Size="Large" Text="campaign_id:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_campaign_id_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Tier_Age_Begin_Month_lbl" runat="server" Font-Size="Large" Text="Tier_Age_Begin_Month:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Tier_Age_Begin_Month_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Tier_Age_Begin_Year_lbl" runat="server" Font-Size="Large" Text="Tier_Age_Begin_Year:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Tier_Age_Begin_Year_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Tier_Age_End_Month_lbl" runat="server" Font-Size="Large" Text="Tier_Age_End_Month:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Tier_Age_End_Month_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Tier_Age_End_Year_lbl" runat="server" Font-Size="Large" Text="Tier_Age_End_Year:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Tier_Age_End_Year_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpetierInfo" runat="server" CollapseControlID="Update_tier_InfoHead" CollapsedText="Show tier Information" Enabled="True" ExpandControlID="Update_tier_InfoHead" ExpandedText="tier Information" TargetControlID="Update_tier_InfoBody" TextLabelID="Update_tier_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_tier_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [tier_id], [include_req], [campaign_id], [Tier_Age_Begin_Month], [Tier_Age_Begin_Year], [Tier_Age_End_Month], [Tier_Age_End_Year] FROM [tier]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_tier_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_tier_InfoHead_label" Style="padding: 10px" runat="server" Text="tier Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_tier_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_tier_id_lbl" runat="server" Font-Size="Large" Text="tier_id:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_tier_id_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_include_req_lbl" runat="server" Font-Size="Large" Text="include_req:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_include_req_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_campaign_id_lbl" runat="server" Font-Size="Large" Text="campaign_id:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_campaign_id_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Tier_Age_Begin_Month_lbl" runat="server" Font-Size="Large" Text="Tier_Age_Begin_Month:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Tier_Age_Begin_Month_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Tier_Age_Begin_Year_lbl" runat="server" Font-Size="Large" Text="Tier_Age_Begin_Year:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Tier_Age_Begin_Year_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Tier_Age_End_Month_lbl" runat="server" Font-Size="Large" Text="Tier_Age_End_Month:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Tier_Age_End_Month_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Tier_Age_End_Year_lbl" runat="server" Font-Size="Large" Text="Tier_Age_End_Year:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Tier_Age_End_Year_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpetierInfo" runat="server" CollapseControlID="Delete_tier_InfoHead" CollapsedText="Show tier Information" Enabled="True" ExpandControlID="Delete_tier_InfoHead" ExpandedText="tier Information" TargetControlID="Delete_tier_InfoBody" TextLabelID="Delete_tier_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
