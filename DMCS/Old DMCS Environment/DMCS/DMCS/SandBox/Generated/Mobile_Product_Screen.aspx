<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="Mobile_Product_Screen.aspx.cs" Inherits="DMCS.SandBox.Generated.Mobile_Product_Screen" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_Mobile_Product_GridView" Style="border-style: solid none none none;" 
                                            Font-Size="Medium" runat="server" DataSourceID="Insert_SqlDataSource2" AutoGenerateColumns="False" 
                                            DataKeyNames="Mobile_Product_id" BackColor="#CCCCCC" BorderColor="#666666" BorderStyle="Solid" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Mobile_Product_id], [Mobile_Unit_id], [Product_id], [Case_id], [Lot_id], [Min_inv], [Quantity], [Experiation_Date] FROM [Mobile_Product]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_Mobile_Product_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_Mobile_Product_InfoHead_label" Style="padding: 10px" runat="server" Text="Mobile_Product Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_Mobile_Product_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                            ...
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Mobile_Unit_id_lbl" runat="server" Font-Size="Large" Text="Mobile_Unit_id:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Mobile_Unit_id_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpeMobile_ProductInfo" runat="server" CollapseControlID="Insert_Mobile_Product_InfoHead" CollapsedText="Show Mobile_Product Information" Enabled="True" ExpandControlID="Insert_Mobile_Product_InfoHead" ExpandedText="Mobile_Product Information" TargetControlID="Insert_Mobile_Product_InfoBody" TextLabelID="Insert_Mobile_Product_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_Mobile_Product_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Mobile_Product_id], [Mobile_Unit_id], [Product_id], [Case_id], [Lot_id], [Min_inv], [Quantity], [Experiation_Date] FROM [Mobile_Product]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_Mobile_Product_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_Mobile_Product_InfoHead_label" Style="padding: 10px" runat="server" Text="Mobile_Product Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_Mobile_Product_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Mobile_Product_id_lbl" runat="server" Font-Size="Large" Text="Mobile_Product_id:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Mobile_Product_id_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Mobile_Unit_id_lbl" runat="server" Font-Size="Large" Text="Mobile_Unit_id:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Mobile_Unit_id_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpeMobile_ProductInfo" runat="server" CollapseControlID="Update_Mobile_Product_InfoHead" CollapsedText="Show Mobile_Product Information" Enabled="True" ExpandControlID="Update_Mobile_Product_InfoHead" ExpandedText="Mobile_Product Information" TargetControlID="Update_Mobile_Product_InfoBody" TextLabelID="Update_Mobile_Product_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_Mobile_Product_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Mobile_Product_id], [Mobile_Unit_id], [Product_id], [Case_id], [Lot_id], [Min_inv], [Quantity], [Experiation_Date] FROM [Mobile_Product]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_Mobile_Product_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_Mobile_Product_InfoHead_label" Style="padding: 10px" runat="server" Text="Mobile_Product Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_Mobile_Product_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Mobile_Product_id_lbl" runat="server" Font-Size="Large" Text="Mobile_Product_id:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Mobile_Product_id_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Mobile_Unit_id_lbl" runat="server" Font-Size="Large" Text="Mobile_Unit_id:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Mobile_Unit_id_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpeMobile_ProductInfo" runat="server" CollapseControlID="Delete_Mobile_Product_InfoHead" CollapsedText="Show Mobile_Product Information" Enabled="True" ExpandControlID="Delete_Mobile_Product_InfoHead" ExpandedText="Mobile_Product Information" TargetControlID="Delete_Mobile_Product_InfoBody" TextLabelID="Delete_Mobile_Product_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
