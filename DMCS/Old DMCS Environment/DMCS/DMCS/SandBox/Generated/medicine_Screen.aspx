<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="medicine_Screen.aspx.cs" Inherits="DMCS.SandBox.Generated.medicine_Screen" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_medicine_GridView" Style="border-style: solid none none none;" 
                                            Font-Size="Medium" runat="server" DataSourceID="Insert_SqlDataSource2" AutoGenerateColumns="False" 
                                            DataKeyNames="Medicine_Id" BackColor="#CCCCCC" BorderColor="#666666" BorderStyle="Solid" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Medicine_Id], [Medication_type], [Medication_name], [Clients_Served] FROM [medicine]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_medicine_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_medicine_InfoHead_label" Style="padding: 10px" runat="server" Text="medicine Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_medicine_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                            ...
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Medication_type_lbl" runat="server" Font-Size="Large" Text="Medication_type:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Medication_type_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Medication_name_lbl" runat="server" Font-Size="Large" Text="Medication_name:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Medication_name_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Clients_Served_lbl" runat="server" Font-Size="Large" Text="Clients_Served:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Clients_Served_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpemedicineInfo" runat="server" CollapseControlID="Insert_medicine_InfoHead" CollapsedText="Show medicine Information" Enabled="True" ExpandControlID="Insert_medicine_InfoHead" ExpandedText="medicine Information" TargetControlID="Insert_medicine_InfoBody" TextLabelID="Insert_medicine_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_medicine_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Medicine_Id], [Medication_type], [Medication_name], [Clients_Served] FROM [medicine]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_medicine_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_medicine_InfoHead_label" Style="padding: 10px" runat="server" Text="medicine Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_medicine_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Medicine_Id_lbl" runat="server" Font-Size="Large" Text="Medicine_Id:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Medicine_Id_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Medication_type_lbl" runat="server" Font-Size="Large" Text="Medication_type:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Medication_type_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Medication_name_lbl" runat="server" Font-Size="Large" Text="Medication_name:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Medication_name_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Clients_Served_lbl" runat="server" Font-Size="Large" Text="Clients_Served:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Clients_Served_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpemedicineInfo" runat="server" CollapseControlID="Update_medicine_InfoHead" CollapsedText="Show medicine Information" Enabled="True" ExpandControlID="Update_medicine_InfoHead" ExpandedText="medicine Information" TargetControlID="Update_medicine_InfoBody" TextLabelID="Update_medicine_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_medicine_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Medicine_Id], [Medication_type], [Medication_name], [Clients_Served] FROM [medicine]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_medicine_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_medicine_InfoHead_label" Style="padding: 10px" runat="server" Text="medicine Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_medicine_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Medicine_Id_lbl" runat="server" Font-Size="Large" Text="Medicine_Id:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Medicine_Id_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Medication_type_lbl" runat="server" Font-Size="Large" Text="Medication_type:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Medication_type_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Medication_name_lbl" runat="server" Font-Size="Large" Text="Medication_name:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Medication_name_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Clients_Served_lbl" runat="server" Font-Size="Large" Text="Clients_Served:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Clients_Served_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpemedicineInfo" runat="server" CollapseControlID="Delete_medicine_InfoHead" CollapsedText="Show medicine Information" Enabled="True" ExpandControlID="Delete_medicine_InfoHead" ExpandedText="medicine Information" TargetControlID="Delete_medicine_InfoBody" TextLabelID="Delete_medicine_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
