<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="missing_Screen.aspx.cs" Inherits="DMCS.SandBox.Generated.missing_Screen" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_missing_GridView" Style="border-style: solid none none none;" 
                                            Font-Size="Medium" runat="server" DataSourceID="Insert_SqlDataSource2" AutoGenerateColumns="False" 
                                            DataKeyNames="Missing_id" BackColor="#CCCCCC" BorderColor="#666666" BorderStyle="Solid" 
                            ...
                            <asp:BoundField DataField="last_known_location" HeaderText="last_known_location" InsertVisible="False" ReadOnly="True" SortExpression="last_known_location" Visible="false" />
                                            </Columns>
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Missing_id], [client_other_info], [clothing], [date_of_disappearance], [last_known_location] FROM [missing]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_missing_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_missing_InfoHead_label" Style="padding: 10px" runat="server" Text="missing Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_missing_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                            ...
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_client_other_info_lbl" runat="server" Font-Size="Large" Text="client_other_info:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_client_other_info_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_clothing_lbl" runat="server" Font-Size="Large" Text="clothing:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_clothing_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_date_of_disappearance_lbl" runat="server" Font-Size="Large" Text="date_of_disappearance:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_date_of_disappearance_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_last_known_location_lbl" runat="server" Font-Size="Large" Text="last_known_location:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_last_known_location_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpemissingInfo" runat="server" CollapseControlID="Insert_missing_InfoHead" CollapsedText="Show missing Information" Enabled="True" ExpandControlID="Insert_missing_InfoHead" ExpandedText="missing Information" TargetControlID="Insert_missing_InfoBody" TextLabelID="Insert_missing_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_missing_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Missing_id], [client_other_info], [clothing], [date_of_disappearance], [last_known_location] FROM [missing]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_missing_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_missing_InfoHead_label" Style="padding: 10px" runat="server" Text="missing Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_missing_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Missing_id_lbl" runat="server" Font-Size="Large" Text="Missing_id:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Missing_id_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_client_other_info_lbl" runat="server" Font-Size="Large" Text="client_other_info:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_client_other_info_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_clothing_lbl" runat="server" Font-Size="Large" Text="clothing:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_clothing_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_date_of_disappearance_lbl" runat="server" Font-Size="Large" Text="date_of_disappearance:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_date_of_disappearance_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_last_known_location_lbl" runat="server" Font-Size="Large" Text="last_known_location:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_last_known_location_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpemissingInfo" runat="server" CollapseControlID="Update_missing_InfoHead" CollapsedText="Show missing Information" Enabled="True" ExpandControlID="Update_missing_InfoHead" ExpandedText="missing Information" TargetControlID="Update_missing_InfoBody" TextLabelID="Update_missing_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_missing_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [Missing_id], [client_other_info], [clothing], [date_of_disappearance], [last_known_location] FROM [missing]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_missing_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_missing_InfoHead_label" Style="padding: 10px" runat="server" Text="missing Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_missing_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Missing_id_lbl" runat="server" Font-Size="Large" Text="Missing_id:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Missing_id_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_client_other_info_lbl" runat="server" Font-Size="Large" Text="client_other_info:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_client_other_info_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_clothing_lbl" runat="server" Font-Size="Large" Text="clothing:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_clothing_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_date_of_disappearance_lbl" runat="server" Font-Size="Large" Text="date_of_disappearance:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_date_of_disappearance_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_last_known_location_lbl" runat="server" Font-Size="Large" Text="last_known_location:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_last_known_location_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpemissingInfo" runat="server" CollapseControlID="Delete_missing_InfoHead" CollapsedText="Show missing Information" Enabled="True" ExpandControlID="Delete_missing_InfoHead" ExpandedText="missing Information" TargetControlID="Delete_missing_InfoBody" TextLabelID="Delete_missing_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
