<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="transportation_Screen.aspx.cs" Inherits="DMCS.SandBox.Generated.transportation_Screen" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_transportation_GridView" Style="border-style: solid none none none;" 
                                            Font-Size="Medium" runat="server" DataSourceID="Insert_SqlDataSource2" AutoGenerateColumns="False" 
                                            DataKeyNames="transport_id" BackColor="#CCCCCC" BorderColor="#666666" BorderStyle="Solid" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [transport_id], [location_from], [location_to], [no_of_passangers], [pickup_date], [trans_type], [Vehicle_id] FROM [transportation]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_transportation_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_transportation_InfoHead_label" Style="padding: 10px" runat="server" Text="transportation Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_transportation_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                            ...
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_location_from_lbl" runat="server" Font-Size="Large" Text="location_from:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_location_from_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_location_to_lbl" runat="server" Font-Size="Large" Text="location_to:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_location_to_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_no_of_passangers_lbl" runat="server" Font-Size="Large" Text="no_of_passangers:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_no_of_passangers_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_pickup_date_lbl" runat="server" Font-Size="Large" Text="pickup_date:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_pickup_date_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_trans_type_lbl" runat="server" Font-Size="Large" Text="trans_type:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_trans_type_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Vehicle_id_lbl" runat="server" Font-Size="Large" Text="Vehicle_id:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Vehicle_id_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpetransportationInfo" runat="server" CollapseControlID="Insert_transportation_InfoHead" CollapsedText="Show transportation Information" Enabled="True" ExpandControlID="Insert_transportation_InfoHead" ExpandedText="transportation Information" TargetControlID="Insert_transportation_InfoBody" TextLabelID="Insert_transportation_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_transportation_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [transport_id], [location_from], [location_to], [no_of_passangers], [pickup_date], [trans_type], [Vehicle_id] FROM [transportation]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_transportation_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_transportation_InfoHead_label" Style="padding: 10px" runat="server" Text="transportation Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_transportation_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_transport_id_lbl" runat="server" Font-Size="Large" Text="transport_id:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_transport_id_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_location_from_lbl" runat="server" Font-Size="Large" Text="location_from:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_location_from_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_location_to_lbl" runat="server" Font-Size="Large" Text="location_to:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_location_to_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_no_of_passangers_lbl" runat="server" Font-Size="Large" Text="no_of_passangers:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_no_of_passangers_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_pickup_date_lbl" runat="server" Font-Size="Large" Text="pickup_date:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_pickup_date_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_trans_type_lbl" runat="server" Font-Size="Large" Text="trans_type:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_trans_type_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpetransportationInfo" runat="server" CollapseControlID="Update_transportation_InfoHead" CollapsedText="Show transportation Information" Enabled="True" ExpandControlID="Update_transportation_InfoHead" ExpandedText="transportation Information" TargetControlID="Update_transportation_InfoBody" TextLabelID="Update_transportation_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_transportation_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [transport_id], [location_from], [location_to], [no_of_passangers], [pickup_date], [trans_type], [Vehicle_id] FROM [transportation]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_transportation_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_transportation_InfoHead_label" Style="padding: 10px" runat="server" Text="transportation Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_transportation_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_transport_id_lbl" runat="server" Font-Size="Large" Text="transport_id:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_transport_id_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_location_from_lbl" runat="server" Font-Size="Large" Text="location_from:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_location_from_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_location_to_lbl" runat="server" Font-Size="Large" Text="location_to:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_location_to_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_no_of_passangers_lbl" runat="server" Font-Size="Large" Text="no_of_passangers:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_no_of_passangers_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_pickup_date_lbl" runat="server" Font-Size="Large" Text="pickup_date:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_pickup_date_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_trans_type_lbl" runat="server" Font-Size="Large" Text="trans_type:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_trans_type_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpetransportationInfo" runat="server" CollapseControlID="Delete_transportation_InfoHead" CollapsedText="Show transportation Information" Enabled="True" ExpandControlID="Delete_transportation_InfoHead" ExpandedText="transportation Information" TargetControlID="Delete_transportation_InfoBody" TextLabelID="Delete_transportation_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
