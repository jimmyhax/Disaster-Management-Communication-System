<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="Shipment_Screen.aspx.cs" Inherits="DMCS.SandBox.Generated.Shipment_Screen" %>
    ...
    <body>
        ...
        <asp:TabContainer ID="MyAjaxTabContainer" runat="server" UseVerticalStripPlacement="false" ActiveTabIndex="2" Visible="True" BackColor="#e75050" ForeColor="#333333" BorderColor="#E75050" BorderStyle="Double" BorderWidth="10px">
                <asp:TabPanel ID="Insert_Tab_Panel" runat="server" HeaderText="Insert" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Insert_Shipment_GridView" Style="border-style: solid none none none;" 
                                            Font-Size="Medium" runat="server" DataSourceID="Insert_SqlDataSource2" AutoGenerateColumns="False" 
                                            DataKeyNames="ShipmentID" BackColor="#CCCCCC" BorderColor="#666666" BorderStyle="Solid" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Insert_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [ShipmentID], [WarehouseID], [Tracking_Num], [Ship_Method], [Other], [OrderRecByID], [FullOrderReceived] FROM [Shipment]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Insert_Shipment_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Insert_Shipment_InfoHead_label" Style="padding: 10px" runat="server" Text="Shipment Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Insert_Shipment_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                        ...
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Tracking_Num_lbl" runat="server" Font-Size="Large" Text="Tracking_Num:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Tracking_Num_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Ship_Method_lbl" runat="server" Font-Size="Large" Text="Ship_Method:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Ship_Method_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_Other_lbl" runat="server" Font-Size="Large" Text="Other:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_Other_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_OrderRecByID_lbl" runat="server" Font-Size="Large" Text="OrderRecByID:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_OrderRecByID_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Insert_FullOrderReceived_lbl" runat="server" Font-Size="Large" Text="FullOrderReceived:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Insert_FullOrderReceived_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Insert_cpeShipmentInfo" runat="server" CollapseControlID="Insert_Shipment_InfoHead" CollapsedText="Show Shipment Information" Enabled="True" ExpandControlID="Insert_Shipment_InfoHead" ExpandedText="Shipment Information" TargetControlID="Insert_Shipment_InfoBody" TextLabelID="Insert_Shipment_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Update_Tab_Panel" runat="server" HeaderText="Update" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Update_Shipment_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Update_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [ShipmentID], [WarehouseID], [Tracking_Num], [Ship_Method], [Other], [OrderRecByID], [FullOrderReceived] FROM [Shipment]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Update_Shipment_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Update_Shipment_InfoHead_label" Style="padding: 10px" runat="server" Text="Shipment Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Update_Shipment_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Tracking_Num_lbl" runat="server" Font-Size="Large" Text="Tracking_Num:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Tracking_Num_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Ship_Method_lbl" runat="server" Font-Size="Large" Text="Ship_Method:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Ship_Method_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_Other_lbl" runat="server" Font-Size="Large" Text="Other:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_Other_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_OrderRecByID_lbl" runat="server" Font-Size="Large" Text="OrderRecByID:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_OrderRecByID_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Update_FullOrderReceived_lbl" runat="server" Font-Size="Large" Text="FullOrderReceived:"></asp:Label>
                                                     <br />
                                                     <asp:TextBox ID="Update_FullOrderReceived_txt" runat="server" Text="" Width="121px"></asp:TextBox>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Update_cpeShipmentInfo" runat="server" CollapseControlID="Update_Shipment_InfoHead" CollapsedText="Show Shipment Information" Enabled="True" ExpandControlID="Update_Shipment_InfoHead" ExpandedText="Shipment Information" TargetControlID="Update_Shipment_InfoBody" TextLabelID="Update_Shipment_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
                <asp:TabPanel ID="Delete_Tab_Panel" runat="server" HeaderText="Delete" Enabled="true" ScrollBars="Auto" BackColor="#EFEEEF" BorderColor="#666666" BorderStyle="Solid" EnableTheming="True">
                    <ContentTemplate>
                        <div>
                            ...
                            <table width="100%" height="100%" bgcolor="#e2e2e2" border="3" style="font-family: 'Calibri Light'">
                                <tr>
                                    <td style="padding: 10px 0px 0px 0px">
                                        <asp:GridView ID="Delete_Shipment_GridView" Style="border-style: solid none none none;" 
                    ...
                    <asp:SqlDataSource runat="server" ID="Delete_SqlDataSource2" ConnectionString="<%$ ConnectionStrings:localhost %>" SelectCommand= "SELECT [ShipmentID], [WarehouseID], [Tracking_Num], [Ship_Method], [Other], [OrderRecByID], [FullOrderReceived] FROM [Shipment]"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Delete_Shipment_InfoHead" runat="server" ForeColor="#EFEEEF" Height="25px" BackImageUrl="~/Images/panelheader1.jpg">
                                <asp:Label ID="Delete_Shipment_InfoHead_label" Style="padding: 10px" runat="server" Text="Shipment Information" Font-Size="Large"></asp:Label>
                            </asp:Panel>
                            <asp:Panel ID="Delete_Shipment_InfoBody" runat="server" style="overflow:hidden;">
                                <div>
                                    <table width="100%" height="auto" bgcolor="#666666" border="3" style="font-family: 'Calibri Light'; color: #E2E2E2;">
                                        <tr>
                                            <th colspan="4" style="padding: 5px 10px 5px 10px; background-color: #aaaaaa;" width="100%">
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Tracking_Num_lbl" runat="server" Font-Size="Large" Text="Tracking_Num:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Tracking_Num_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Ship_Method_lbl" runat="server" Font-Size="Large" Text="Ship_Method:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Ship_Method_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_Other_lbl" runat="server" Font-Size="Large" Text="Other:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_Other_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_OrderRecByID_lbl" runat="server" Font-Size="Large" Text="OrderRecByID:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_OrderRecByID_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                                 <td style="padding: 20px 10px 10px 10px">
                                                     <asp:Label ID="Delete_FullOrderReceived_lbl" runat="server" Font-Size="Large" Text="FullOrderReceived:"></asp:Label>
                                                     <br />
                                                     <asp:Label ID="Delete_FullOrderReceived_txt_lbl" runat="server" Text="" Width="121px"></asp:Label>
                                                     <br />
                                                 </td>
                                            </tr>
                                        </tr>
                            ...
                            <asp:CollapsiblePanelExtender ID="Delete_cpeShipmentInfo" runat="server" CollapseControlID="Delete_Shipment_InfoHead" CollapsedText="Show Shipment Information" Enabled="True" ExpandControlID="Delete_Shipment_InfoHead" ExpandedText="Shipment Information" TargetControlID="Delete_Shipment_InfoBody" TextLabelID="Delete_Shipment_InfoHead_label"></asp:CollapsiblePanelExtender>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
            </asp:TabContainer>
