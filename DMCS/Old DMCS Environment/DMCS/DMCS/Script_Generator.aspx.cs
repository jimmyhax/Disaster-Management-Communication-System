...
namespace DMCS
{
    public partial class Script_Generator : System.Web.UI.Page
    {
        ...
        public void GENERATE_SCREEN_Insert_Update_Delete()
        {
            ...
            //Insert_Update_Delete_Output_StringText += "                                        <asp:SqlDataSource ID=\"Insert_SqlDataSource1\" runat=\"server\" ConnectionString=\"<%$ ConnectionStrings:localhost %>\" SelectCommand=\"SELECT [disaster_id], [disaster_name] FROM [disaster]\"></asp:SqlDataSource>" + Environment.NewLine;
            ...
            Insert_Update_Delete_Output_StringText += "                    <asp:SqlDataSource runat=\"server\" ID=\"Insert_SqlDataSource2\" ConnectionString=\"<%$ ConnectionStrings:localhost %>\" SelectCommand= \"SELECT";
            for (int i = 0; i < DB_Array.Length - 1; i++)
            {
                if (i == DB_Array.Length - 1 - 1)
                {
            ...
            //Insert_Update_Delete_Output_StringText += "                                        <asp:SqlDataSource ID=\"Update_SqlDataSource1\" runat=\"server\" ConnectionString=\"<%$ ConnectionStrings:localhost %>\" SelectCommand=\"SELECT [disaster_id], [disaster_name] FROM [disaster]\"></asp:SqlDataSource>" + Environment.NewLine;
            //Insert_Update_Delete_Output_StringText += "                                    </td>" + Environment.NewLine;
            Insert_Update_Delete_Output_StringText += "                                    <td width=\"100%\" style=\"border-style: none; padding: 0px 10px 0px 10px;\" align=\"Center\">" + Environment.NewLine;
            ...
            Insert_Update_Delete_Output_StringText += "                                            <SortedDescendingHeaderStyle BackColor=\"#383838\"></SortedDescendingHeaderStyle>" + Environment.NewLine;
            Insert_Update_Delete_Output_StringText += "                                        </asp:GridView>" + Environment.NewLine;
            Insert_Update_Delete_Output_StringText += "                    <asp:SqlDataSource runat=\"server\" ID=\"Update_SqlDataSource2\" ConnectionString=\"<%$ ConnectionStrings:localhost %>\" SelectCommand= \"SELECT";
            for (int i = 0; i < DB_Array.Length - 1; i++)
            {
                if (i == DB_Array.Length - 1 - 1)
                {
            ...
            //Insert_Update_Delete_Output_StringText += "                                        <asp:SqlDataSource ID=\"Delete_SqlDataSource1\" runat=\"server\" ConnectionString=\"<%$ ConnectionStrings:localhost %>\" SelectCommand=\"SELECT [disaster_id], [disaster_name] FROM [disaster]\"></asp:SqlDataSource>" + Environment.NewLine;
            //Insert_Update_Delete_Output_StringText += "                                    </td>" + Environment.NewLine;
            Insert_Update_Delete_Output_StringText += "                                    <td width=\"100%\" style=\"border-style: none; padding: 0px 10px 0px 10px;\" align=\"Center\">" + Environment.NewLine;
            ...
            Insert_Update_Delete_Output_StringText += "                                            <SortedDescendingHeaderStyle BackColor=\"#383838\"></SortedDescendingHeaderStyle>" + Environment.NewLine;
            Insert_Update_Delete_Output_StringText += "                                        </asp:GridView>" + Environment.NewLine;
            Insert_Update_Delete_Output_StringText += "                    <asp:SqlDataSource runat=\"server\" ID=\"Delete_SqlDataSource2\" ConnectionString=\"<%$ ConnectionStrings:localhost %>\" SelectCommand= \"SELECT";
            for (int i = 0; i < DB_Array.Length - 1; i++)
            {
                if (i == DB_Array.Length - 1 - 1)
                {
